            ...
            if not user.is_active:
                ...
                success_message = """
                    <div style="background-color: #d4edda; color: #155724; padding: 15px; border: 1px solid #c3e6cb; border-radius: 4px;">
                        ...
                        <a href="https://phimart-hotel-client-fggl.vercel.app/login" style="background-color: #007bff; color: white; padding: 10px 15px; text-decoration: none; border-radius: 4px;">Login Now</a>
                    </div>
                """
